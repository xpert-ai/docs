...
![SAP BPC environment: BPC420_00](/public/img/data/sap-bpc/bpc-environment.svg)

BPC Model:

![SAP BPC Consolidation model](/public/img/data/sap-bpc/consolidation-model.svg)
...
![Find the BW model in UJA_APPL](/public/img/data/sap-bpc/bpc-applications.svg)
...
![Create the SAP BW semantic model entity](/public/img/data/sap-bpc/semantic-model.svg)
