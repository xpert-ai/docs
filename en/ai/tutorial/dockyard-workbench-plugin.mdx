...
The tutorial focuses on responsibilities, implementation steps, and validation. See [Dockyard demo PR #627](https://github.com/xpert-ai/xpert-plugins/pull/627) for the complete implementation and development materials. The PR has been merged into the official repository’s main branch. The example is pinned to merge [commit 9871c50f](https://github.com/xpert-ai/xpert-plugins/tree/9871c50f408d19ae3e6c3951721ab1c4574185c6/community/apps/dockyard). The PR includes code changes, validation records, and six supporting documents. Use the pinned commit in the official repository to reproduce the example. This is a development case study, not a published npm plugin.
...
To run the pinned example first, clone the official repository into a separate directory:
...
- [Pinned example and six development documents](https://github.com/xpert-ai/xpert-plugins/tree/9871c50f408d19ae3e6c3951721ab1c4574185c6/community/apps/dockyard/docs/interview)
