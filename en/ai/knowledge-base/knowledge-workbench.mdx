...
For graph extraction, lifecycle, retrieval modes, curation, and Agent exploration, see [Knowledge Graph and GraphRAG](/en/ai/knowledge-base/knowledge-graph-graphrag).
