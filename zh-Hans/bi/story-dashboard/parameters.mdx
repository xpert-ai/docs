...
![计算公式中使用参数](/public/img/story/parameter/parameter-in-calculated-measure.png)
...
![Small](/public/img/story/parameter/parameter-input.png)

#### 选择项参数

可以手动创建几条固定可选项供用户选择, 选择一条作为默认值

![Small](/public/img/story/parameter/parameter-select.png)
...
![Middle](/public/img/story/parameter/parameter-in-restricted-measure.png)

创建维度成员选择参数, 如下图所示维度成员列表会根据维度选择器里设置的层次结构将维度成员展示出来, 你可以选中多个想要让用户选择的成员, 点击应用创建参数.

![Small](/public/img/story/parameter/parameter-dimension-members.png)

## 条件聚合使用参数

在条件聚合的维度上也可以使用参数, 创建过程跟其他的维度参数相同. 如下图所示, 要计算用户选择的门店的平均利润.

![Middle](/public/img/story/parameter/parameter-in-conditional-aggregation.png)
...
![Small](/public/img/story/parameter/parameter-input-control.png)

输入控制器将展示维度成员或者输入框供用户选择和输入值

![Small](/public/img/story/parameter/parameter-input-control-widgets.png)
