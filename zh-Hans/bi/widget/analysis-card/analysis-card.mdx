...
<figure className="Large">
  <img src="/img/story/chart-variants.png" alt="图形变体" className="" />
  <figcaption>图形变体</figcaption>
</figure>
...
<figure className="Small">
  <img src="/img/widgets/analytical-card/chart-measures.png" alt="图形的度量" className="" />
  <figcaption>图形的度量</figcaption>
</figure>
...
<figure className="Small">
  <img src="/img/widgets/analytical-card/chart-dimensions.png" alt="图形的维度" className="" />
  <figcaption>图形的维度</figcaption>
</figure>
...
<figure className="Small">
  <img src="/en/img/widgets/analytical-card/chart-type.png" alt="Chart Type" className="" />
  <figcaption>Chart Type</figcaption>
</figure>

<figure className="Small">
  <img src="/en/img/widgets/analytical-card/chart-custom.png" alt="Chart Custom" className="" />
  <figcaption>Chart Custom</figcaption>
</figure>
</div>
