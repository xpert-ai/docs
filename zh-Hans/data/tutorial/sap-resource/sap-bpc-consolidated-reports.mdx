...
![SAP BPC 环境：BPC420_00](/public/img/data/sap-bpc/bpc-environment.svg)

BPC 模型:

![SAP BPC Consolidation 模型](/public/img/data/sap-bpc/consolidation-model.svg)
...
![通过 UJA_APPL 定位 BW 模型](/public/img/data/sap-bpc/bpc-applications.svg)

在语义模型界面中的数据表区域查找此模型, 将其拖至 MDX 模型区域, 输入文本描述后即创建了相应的语义模型实体.

![创建 SAP BW 语义模型实体](/public/img/data/sap-bpc/semantic-model.svg)
